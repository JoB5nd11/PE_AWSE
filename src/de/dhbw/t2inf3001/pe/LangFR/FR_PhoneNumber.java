...
//Spezielle klasse für die Darstellung der Telefonnummern in der FR-Darstellung, implementiert das PhoneNumber-Interface
public class FR_PhoneNumber implements PhoneNumber{
	...
	//Format Methode nutzt das Builder Pattern zur Formatierung der Telefondaten im FR-Format
	...
	//FormatInternational Methode nutzt ebenfalls das Builder Pattern zur Formatierung der internationalen Telefondaten im FR-Format
	//Anschließend werden diese als String zurück gegeben (Getter)
